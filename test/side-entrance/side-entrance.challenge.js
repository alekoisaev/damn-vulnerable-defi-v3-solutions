...
describe('[Challenge] Side entrance', function () {
  ...
  it('Execution', async function () {
    ...
    const Attacker = await ethers.getContractFactory('AttackerSideEntrance');
    const attacker = await Attacker.deploy(pool.address, player.address);

    await attacker.attack();

    await pool.connect(player).withdraw();
  });
